;(function () {
	...
	var featuresAnimate = function() {
		...
		if ( $('#home-features').length > 0 ) {
			$('#home-features .to-animate').each(function( k ) {
	...
	var featuresWayPoint = function() {
		...
		if ( $('#home-features').length > 0 ) {
			$('#home-features').waypoint( function( direction ) {
	...
	var pricingAnimate = function() {
		...
		if ( $('#home-pricing').length > 0 ) {
			$('#home-pricing .to-animate').each(function( k ) {
	...
	var pricingWayPoint = function() {
		...
		if ( $('#home-pricing').length > 0 ) {
			$('#home-pricing').waypoint( function( direction ) {
